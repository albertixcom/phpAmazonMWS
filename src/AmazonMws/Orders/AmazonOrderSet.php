 ...
 * class instead.
 */
class AmazonOrderSet extends \AmazonMws\Core\AmazonOrderCore implements \Iterator {
    protected $i = 0;
    protected $index = 0;
    protected $orderList;
     ...
     */
    public function __construct(\AmazonMws\Config\AmazonStore $store, string $o = null){
